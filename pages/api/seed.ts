...
export default async function handler(req: NextApiRequest, res: NextApiResponse<Data>) {
  ...
  await prisma.cuisines.deleteMany();
  ...
  const userLaith = await prisma.users.create({
    data: {
      first_name: 'Laith',
      last_name: 'Harb',
  ...
  const userJosh = await prisma.users.create({
    data: {
      first_name: 'Josh',
      last_name: 'Allen',
  ...
  const userLebron = await prisma.users.create({
    data: {
      first_name: 'LeBron',
      last_name: 'James',
  ...
  const userCassidy = await prisma.users.create({
    data: {
      first_name: 'Cassidy',
      last_name: 'Marksom',
